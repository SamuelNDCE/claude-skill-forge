...
- Use broad single-word substring rules (e.g. `BusinessName==>the-store`) rather than trying to match every phrasing variant exactly — safer and catches variants you didn't enumerate.
